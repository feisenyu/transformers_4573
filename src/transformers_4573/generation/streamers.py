...
class TextIteratorStreamer(TextStreamer):
    ...
    Examples:
        ...
        ```python
        >>> from transformers_4573 import AutoModelForCausalLM, AutoTokenizer, TextIteratorStreamer
...
class AsyncTextIteratorStreamer(TextStreamer):
    ...
    Examples:
        ...
        ```python
        >>> from transformers_4573 import AutoModelForCausalLM, AutoTokenizer, AsyncTextIteratorStreamer
        >>> from threading import Thread
        >>> import asyncio
