...
from ...utils import transformers_4573Kwargs, auto_docstring, is_torchdynamo_compiling, logging
...
# Copied from transformers_4573.models.bart.modeling_bart.BartScaledWordEmbedding with Bart->M2M100
...
# Copied from transformers_4573.models.bart.modeling_bart.BartAttention with Bart->M2M100
...
# Copied from transformers_4573.models.mbart.modeling_mbart.MBartEncoderLayer with MBart->M2M100, MBART->M2M100
...
# Copied from transformers_4573.models.mbart.modeling_mbart.MBartDecoderLayer with MBart->M2M100, MBART->M2M100
...
class M2M100ForConditionalGeneration(M2M100PreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs,
        ...
        ```python
        >>> from transformers_4573 import AutoTokenizer, M2M100ForConditionalGeneration
