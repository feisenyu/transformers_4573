...
from transformers_4573 import PegasusConfig, PegasusForConditionalGeneration, PegasusTokenizer
from transformers_4573.models.pegasus.configuration_pegasus import DEFAULTS, task_specific_params
