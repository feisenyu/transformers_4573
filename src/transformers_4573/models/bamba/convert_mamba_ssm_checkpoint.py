...
from transformers_4573.utils import SAFE_WEIGHTS_INDEX_NAME, SAFE_WEIGHTS_NAME
...
# Adapted from transformers_4573.models.mamba.convert_mamba_ssm_checkpoint_to_pytorch.py
