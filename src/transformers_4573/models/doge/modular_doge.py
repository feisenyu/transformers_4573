...
from ...utils import transformers_4573Kwargs, is_torch_flex_attn_available, logging
...
class DogeConfig(PreTrainedConfig):
    ...
    ```python
    >>> from transformers_4573 import DogeConfig, DogeModel
...
class DogeForCausalLM(MixtralForCausalLM):
    ...
    def forward(
        ...
        **kwargs: Unpack[TransformersKwargs],
        ...
        ```python
        >>> from transformers_4573 import AutoTokenizer, DogeForCausalLM
