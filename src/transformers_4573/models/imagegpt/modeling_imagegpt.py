...
class ImageGPTModel(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        ```python
        >>> from transformers_4573 import AutoImageProcessor, ImageGPTModel
...
class ImageGPTForCausalImageModeling(ImageGPTPreTrainedModel, GenerationMixin):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        ```python
        >>> from transformers_4573 import AutoImageProcessor, ImageGPTForCausalImageModeling
        >>> import torch
...
class ImageGPTForImageClassification(ImageGPTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs: Any,
        ...
        ```python
        >>> from transformers_4573 import AutoImageProcessor, ImageGPTForImageClassification
        >>> from PIL import Image
        >>> import requests
