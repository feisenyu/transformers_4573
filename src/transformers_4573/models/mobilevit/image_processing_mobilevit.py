...
class MobileViTImageProcessor(BaseImageProcessor):
    ...
    # Copied from transformers_4573.models.mobilenet_v1.image_processing_mobilenet_v1.MobileNetV1ImageProcessor.resize with PILImageResampling.BICUBIC->PILImageResampling.BILINEAR
    def resize(
        self,
        image: np.ndarray,
        size: dict[str, int],
    ...
    # Copied from transformers_4573.models.beit.image_processing_beit.BeitImageProcessor.post_process_semantic_segmentation with Beit->MobileViT
