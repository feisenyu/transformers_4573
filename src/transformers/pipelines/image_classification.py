...
# Copied from transformers_4573.pipelines.text_classification.sigmoid
def sigmoid(_outputs):
    return 1.0 / (1.0 + np.exp(-_outputs))


# Copied from transformers_4573.pipelines.text_classification.softmax
...
# Copied from transformers_4573.pipelines.text_classification.ClassificationFunction
