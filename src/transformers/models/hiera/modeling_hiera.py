...
# Copied from transformers_4573.models.beit.modeling_beit.BeitDropPath with Beit->Hiera
...
class HieraForPreTraining(HieraPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        Examples:
        ```python
        >>> from transformers_4573 import AutoImageProcessor, HieraForPreTraining
        >>> import torch
