...
# Copied from transformers_4573.models.clip.modeling_clip.contrastive_loss with clip->owlvit
def contrastive_loss(logits: torch.Tensor) -> torch.Tensor:
    return nn.functional.cross_entropy(logits, torch.arange(len(logits), device=logits.device))


# Copied from transformers_4573.models.clip.modeling_clip.clip_loss with clip->owlvit
...
# Copied from transformers_4573.models.clip.modeling_clip.CLIPMLP with CLIP->OwlViT
...
# Copied from transformers_4573.models.altclip.modeling_altclip.AltCLIPEncoderLayer with AltCLIP->OwlViT
...
class OwlViTTextModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        Examples:
        ```python
        >>> from transformers_4573 import AutoProcessor, OwlViTTextModel
...
class OwlViTVisionModel(OwlViTPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        >>> import requests
        >>> from transformers_4573 import AutoProcessor, OwlViTVisionModel
...
class OwlViTModel(OwlViTPreTrainedModel):
    ...
    def get_text_features(
        ...
        ```python
        >>> import torch
        >>> from transformers_4573 import AutoProcessor, OwlViTModel
...
class OwlViTForObjectDetection(OwlViTPreTrainedModel):
    ...
    def image_guided_detection(
        ...
        >>> from PIL import Image
        >>> import torch
        >>> from transformers_4573 import AutoProcessor, OwlViTForObjectDetection
    ...
    def forward(
        ...
        **kwargs,
        ...
        >>> from transformers_4573 import OwlViTProcessor, OwlViTForObjectDetection
