...
```py
from transformers_4573 import SwinConfig, UperNetConfig, UperNetForSemanticSegmentation
...
```py
from transformers_4573 import ConvNextConfig, UperNetConfig, UperNetForSemanticSegmentation
