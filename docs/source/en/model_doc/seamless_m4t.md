...
```python
>>> from transformers_4573 import AutoProcessor, SeamlessM4TModel
...
```python
>>> from transformers_4573 import SeamlessM4TForSpeechToSpeech
...
```python
>>> from transformers_4573 import SeamlessM4TForTextToText
