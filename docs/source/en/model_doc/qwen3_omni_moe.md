...
from transformers_4573 import Qwen3OmniMoeForConditionalGeneration, Qwen3OmniMoeProcessor
...
```python
from transformers_4573 import Qwen3OmniMoeThinkerForConditionalGeneration, Qwen3OmniMoeProcessor
...
```python
from transformers_4573 import Qwen3OmniMoeForConditionalGeneration
