...
- "Copied from" syntax. Functions or entire classes can have a comment at the top like this: `# Copied from transformers_4573.models.llama.modeling_llama.rotate_half` or `# Copied from transformers_4573.models.t5.modeling_t5.T5LayerNorm with T5->MT5`
