...
from transformers_4573 import AutoConfig, AutoModelForCausalLM, AutoTokenizer, EetqConfig, OPTForCausalLM
...
class EetqTest(unittest.TestCase):
    ...
    def test_quantized_model_conversion(self):
        ...
        """
        from transformers_4573.integrations import replace_with_eetq_linear
        from transformers_4573.integrations.eetq import EetqLinear
