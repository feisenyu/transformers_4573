...
class BitNetTest(unittest.TestCase):
    ...
    def test_replace_with_bitlinear(self):
        from transformers_4573.integrations import BitLinear, replace_with_bitnet_linear
    ...
    def test_packing_unpacking(self):
        ...
        from transformers_4573.integrations import pack_weights, unpack_weights
    ...
    def test_activation_quant(self):
        ...
        from transformers_4573.integrations import BitLinear
    ...
    def test_replace_with_bitlinear_shape(self):
        ...
        from transformers_4573.integrations import replace_with_bitnet_linear
