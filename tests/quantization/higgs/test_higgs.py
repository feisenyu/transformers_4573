...
from transformers_4573 import AutoConfig, AutoModelForCausalLM, AutoTokenizer, HiggsConfig, OPTForCausalLM
...
class HiggsTest(unittest.TestCase):
    ...
    def test_quantized_model_conversion(self):
        ...
        from transformers_4573.integrations import HiggsLinear, replace_with_higgs_linear
