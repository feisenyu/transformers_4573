...
from transformers_4573.trainer_utils import get_last_checkpoint, set_seed
from transformers_4573.utils import SAFE_WEIGHTS_NAME, is_torch_bf16_available_on_device, is_torch_fp16_available_on_device
...
if is_deepspeed_available():
    ...
    from transformers_4573.integrations.deepspeed import deepspeed_config, is_deepspeed_zero3_enabled  # noqa
...
class CoreIntegrationDeepSpeed(TestCasePlus, TrainerIntegrationCommon):
    ...
    def test_init_zero3_missing_params(self):
        ...
        from transformers_4573.models.gpt2.modeling_gpt2 import GPT2Model, GPT2PreTrainedModel
    ...
    def test_arange_bf16(self):
        ...
        good_deepspeed_create_sinusoidal_positions = transformers_4573.models.gptj.modeling_gptj.create_sinusoidal_positions
...
class TrainerIntegrationDeepSpeed(TrainerIntegrationDeepSpeedWithCustomConfig, TrainerIntegrationCommon):
    ...
    #     from transformers_4573 import Trainer  # noqa
    ...
    def test_load_best_model(self, stage, dtype):
        ...
        from transformers_4573 import T5ForConditionalGeneration, T5Tokenizer, Trainer  # noqa
