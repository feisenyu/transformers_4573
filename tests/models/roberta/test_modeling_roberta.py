...
from transformers_4573 import AutoTokenizer, RobertaConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_4573.models.roberta.modeling_roberta import RobertaEmbeddings
