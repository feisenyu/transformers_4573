...
from transformers_4573 import WhisperTokenizer, WhisperTokenizerFast, is_speech_available
...
if is_speech_available():
    from transformers_4573 import WhisperFeatureExtractor, WhisperProcessor
