...
from transformers_4573 import Speech2TextFeatureExtractor
...
class Speech2TextFeatureExtractionWithoutTorchaudioTest(Speech2TextFeatureExtractionTest):
    def test_using_audio_utils(self):
        ...
        from transformers_4573.models.speech_to_text.feature_extraction_speech_to_text import is_speech_available
