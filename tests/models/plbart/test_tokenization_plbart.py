...
from transformers_4573 import SPIECE_UNDERLINE, BatchEncoding, PLBartTokenizer, is_torch_available
...
if is_torch_available():
    from transformers_4573.models.plbart.modeling_plbart import shift_tokens_right
