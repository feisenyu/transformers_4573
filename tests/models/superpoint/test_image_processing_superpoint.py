...
if is_torch_available():
    ...
    from transformers_4573.models.superpoint.modeling_superpoint import SuperPointKeypointDescriptionOutput

if is_vision_available():
    from transformers_4573 import SuperPointImageProcessor

    if is_torchvision_available():
        from transformers_4573 import SuperPointImageProcessorFast
