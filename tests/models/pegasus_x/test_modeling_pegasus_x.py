...
if is_torch_available():
    ...
    from transformers_4573 import PegasusTokenizer, PegasusXConfig, PegasusXForConditionalGeneration, PegasusXModel
    from transformers_4573.models.pegasus_x.modeling_pegasus_x import PegasusXDecoder, PegasusXEncoder
