...
from transformers_4573 import OwlViTConfig, OwlViTTextConfig, OwlViTVisionConfig
...
if is_torch_available():
    ...
    from transformers_4573 import OwlViTForObjectDetection, OwlViTModel, OwlViTTextModel, OwlViTVisionModel
