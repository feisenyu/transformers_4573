...
from transformers_4573 import ImageGPTConfig
from transformers_4573.testing_utils import require_torch, require_vision, run_test_using_subprocess, slow, torch_device
