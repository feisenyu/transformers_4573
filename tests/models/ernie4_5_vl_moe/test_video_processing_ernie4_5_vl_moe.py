...
if is_vision_available():
    if is_torchvision_available():
        from transformers_4573 import Ernie4_5_VL_MoeVideoProcessor
        from transformers_4573.models.ernie4_5_vl_moe.video_processing_ernie4_5_vl_moe import smart_resize
