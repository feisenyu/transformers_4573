...
from transformers_4573 import Phi4MultimodalFeatureExtractor
from transformers_4573.testing_utils import check_json_file_has_correct_format, require_torch
...
class Phi4MultimodalFeatureExtractionTest(SequenceFeatureExtractionTestMixin, unittest.TestCase):
    ...
    @unittest.mock.patch(
        "transformers_4573.models.phi4_multimodal.feature_extraction_phi4_multimodal.is_torch_available", lambda: False
    )
