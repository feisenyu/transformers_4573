...
from transformers_4573 import GPTBigCodeConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_4573.models.gpt_bigcode.modeling_gpt_bigcode import GPTBigCodeAttention
