...
from transformers_4573.testing_utils import get_device_properties, require_torch, require_vision, slow, torch_device
...
if is_torch_available():
    ...
    from transformers_4573 import LightGlueForKeypointMatching
