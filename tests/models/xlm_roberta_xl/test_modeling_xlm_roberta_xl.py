...
from transformers_4573 import XLMRobertaXLConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_4573.models.xlm_roberta_xl.modeling_xlm_roberta_xl import XLMRobertaXLEmbeddings
