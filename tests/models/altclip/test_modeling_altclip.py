...
from transformers_4573 import AltCLIPConfig, AltCLIPProcessor, AltCLIPTextConfig, AltCLIPVisionConfig
...
if is_torch_available():
    ...
    from transformers_4573 import AltCLIPModel, AltCLIPTextModel, AltCLIPVisionModel
