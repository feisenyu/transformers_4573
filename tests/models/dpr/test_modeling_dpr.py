...
from transformers_4573 import DPRConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_4573 import DPRContextEncoder, DPRQuestionEncoder, DPRReader, DPRReaderTokenizer
