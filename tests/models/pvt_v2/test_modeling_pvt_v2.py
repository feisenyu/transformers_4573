...
from transformers_4573 import PvtV2Backbone, PvtV2Config, is_torch_available, is_vision_available
...
if is_torch_available():
    ...
    from transformers_4573 import AutoImageProcessor, PvtV2ForImageClassification, PvtV2Model
