...
from transformers_4573 import LongformerConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_4573.models.longformer.modeling_longformer import LongformerSelfAttention
