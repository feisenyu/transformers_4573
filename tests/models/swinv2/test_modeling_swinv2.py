...
from transformers_4573 import Swinv2Config
...
if is_torch_available():
    ...
    from transformers_4573 import Swinv2Backbone, Swinv2ForImageClassification, Swinv2ForMaskedImageModeling, Swinv2Model
