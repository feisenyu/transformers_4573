...
from transformers_4573.testing_utils import check_json_file_has_correct_format, require_torch, require_torchaudio
...
class ASTFeatureExtractionWithoutTorchaudioTest(ASTFeatureExtractionTest):
    def test_using_audio_utils(self):
        ...
        from transformers_4573.models.audio_spectrogram_transformer.feature_extraction_audio_spectrogram_transformer import (
            is_speech_available,
        )
