...
from transformers_4573 import SeamlessM4Tv2Config, is_speech_available, is_torch_available
from transformers_4573.testing_utils import require_speech, require_torch, slow, torch_device
...
if is_speech_available():
    from transformers_4573 import SeamlessM4TProcessor
...
class SeamlessM4Tv2GenerationTest(unittest.TestCase):
    ...
    def test_speech_generation(self):
        ...
        from transformers_4573.testing_utils import set_config_for_less_flaky_test, set_model_for_less_flaky_test
