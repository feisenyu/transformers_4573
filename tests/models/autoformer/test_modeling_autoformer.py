...
if is_torch_available():
    ...
    from transformers_4573 import AutoformerConfig, AutoformerForPrediction, AutoformerModel
    from transformers_4573.models.autoformer.modeling_autoformer import AutoformerDecoder, AutoformerEncoder
