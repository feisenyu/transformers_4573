...
from transformers_4573 import AutoTokenizer, BitsAndBytesConfig, Zamba2Config, is_torch_available
...
if is_torch_available():
    ...
    from transformers_4573.models.zamba2.modeling_zamba2 import (
