...
from transformers_4573 import UnivNetFeatureExtractor
from transformers_4573.testing_utils import check_json_file_has_correct_format, require_torch, slow
