...
from transformers_4573.testing_utils import check_json_file_has_correct_format, require_torch, require_vision
...
if is_torch_available():
    ...
    if is_vision_available():
        from transformers_4573 import CLIPTokenizer, OneFormerImageProcessor, OneFormerProcessor
        from transformers_4573.models.oneformer.image_processing_oneformer import binary_mask_to_rle
