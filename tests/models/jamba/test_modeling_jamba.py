...
from transformers_4573 import AutoTokenizer, BitsAndBytesConfig, JambaConfig, is_torch_available
...
if is_torch_available():
    ...
    from transformers_4573.models.jamba.modeling_jamba import (
