...
from transformers_4573 import EvalPrediction, HfArgumentParser, TrainingArguments, is_torch_available
...
from transformers_4573.training_args import ParallelMode
