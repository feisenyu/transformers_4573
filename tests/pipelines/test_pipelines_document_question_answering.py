...
from transformers_4573.pipelines import DocumentQuestionAnsweringPipeline, pipeline
from transformers_4573.pipelines.document_question_answering import apply_tesseract
