...
from transformers_4573 import MODEL_FOR_IMAGE_TEXT_TO_TEXT_MAPPING, is_vision_available
from transformers_4573.pipelines import ImageTextToTextPipeline, pipeline
