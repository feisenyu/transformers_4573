...
from transformers_4573.trainer_callback import TrainerState
from transformers_4573.trainer_utils import FSDPOption, set_seed
...
if is_torch_available():
    from transformers_4573.trainer import FSDP_MODEL_NAME
