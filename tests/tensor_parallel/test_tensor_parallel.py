...
from transformers_4573 import AutoModelForCausalLM, AutoTokenizer, is_torch_available
from transformers_4573.integrations.tensor_parallel import get_packed_weights, get_tensor_shard, repack_weights
