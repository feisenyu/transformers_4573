...
from transformers_4573 import {{cookiecutter.camelcase_modelname}}Tokenizer, {{cookiecutter.camelcase_modelname}}TokenizerFast
{% elif  cookiecutter.has_slow_class == "True" -%}
from transformers_4573 import {{cookiecutter.camelcase_modelname}}Tokenizer
{% elif  cookiecutter.has_fast_class == "True" -%}
from transformers_4573 import {{cookiecutter.camelcase_modelname}}TokenizerFast
{% endif -%}
...
from transformers_4573.testing_utils import require_sentencepiece
from ...test_tokenization_common import TokenizerTesterMixin
